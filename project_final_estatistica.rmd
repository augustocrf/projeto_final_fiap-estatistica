...
```{r Analise_exploratoria_de_dados_2 message=FALSE, warning=FALSE} 
...
```{r Correlacao Entre Elas - Vinho Tinto message=FALSE, warning=FALSE} 
...
```{r Correlacao Entre Elas - Vinho Branco message=FALSE, warning=FALSE} 
# Correlações entre elas (numéricas e gráficos)
...
```{r Deteccao de outliers - Vinho Tinto message=FALSE, warning=FALSE} 
# Detecção de outliers
attach(red_wine_quality)

```

```{r Deteccao de outliers - Vinho Branco message=FALSE, warning=FALSE} 
# Detecção de outliers
attach(white_wine_quality)
...
```{r Avaliacao da Analise e Correlacao message=FALSE, warning=FALSE} 
...
fx_predito1 <- cut(predito, breaks=c(5,6,7), right=F)
