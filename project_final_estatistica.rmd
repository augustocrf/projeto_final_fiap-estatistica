...
```{r Deteccao de outliers - Vinho Tinto}
# Detecção de outliers
attach(red_wine_quality)

filter(red_wine_quality, outl_fixed.acidity == 1)
filter(red_wine_quality, outl_volatile.acidity == 1)
filter(red_wine_quality, outl_citric.acid == 1)
filter(red_wine_quality, outl_residual.sugar == 1)
filter(red_wine_quality, outl_chlorides == 1)
filter(red_wine_quality, outl_free.sulfur.dioxide == 1)
filter(red_wine_quality, outl_total.sulfur.dioxide == 1)
filter(red_wine_quality, outl_density == 1)
filter(red_wine_quality, outl_pH == 1)
filter(red_wine_quality, outl_sulphates == 1)
filter(red_wine_quality, outl_alcohol == 1)

```

- Detecção de Outliers - Vinho Branco

```{r Deteccao de outliers - Vinho Branco}
# Detecção de outliers
attach(white_wine_quality)

filter(white_wine_quality, outl_fixed.acidity == 1)
filter(white_wine_quality, outl_volatile.acidity == 1)
filter(white_wine_quality, outl_citric.acid == 1)
filter(white_wine_quality, outl_residual.sugar == 1)
filter(white_wine_quality, outl_chlorides == 1)
filter(white_wine_quality, outl_free.sulfur.dioxide == 1)
filter(white_wine_quality, outl_total.sulfur.dioxide == 1)
filter(white_wine_quality, outl_density == 1)
filter(white_wine_quality, outl_pH == 1)
filter(white_wine_quality, outl_sulphates == 1)
filter(white_wine_quality, outl_alcohol == 1)
...
```{r Avaliacao da Analise e Correlacao}
